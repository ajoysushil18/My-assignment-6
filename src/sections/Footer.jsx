export default function Footer() {
  return (
    <footer className="bg-[#101727] text-white p-10 md:px-16 lg:px-32 md:py-0">
      <div className="footer sm:footer-horizontal pt-28">
        ...
        <nav>
          ...
          <a className="text-gray-400">Templates</a>
          <a className="text-gray-400">Intregation</a>
        </nav>
        <nav>
          ...
          <a className="text-gray-400">Press</a>
        </nav>
        <nav>
          <h6 className="text-white">Resources</h6>
          <a className="text-gray-400">Documentation</a>
          <a className="text-gray-400">HelpCenter</a>
          <a className="text-gray-400">Community</a>
          <a className="text-gray-400">Contact</a>
        </nav>
        <nav className="md:justify-self-end flex flex-col">
